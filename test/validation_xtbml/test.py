...
def test_dir(dir,ref_file,bin,args):
    ...
    to_be_dropped_test = ['delta_qm_e_xx', 'p_d', 'qm_s_zz', 'chem.pot', 'qm_s_yz', 
    ...
    'p_p', 'qm_s', 'dipm_s_y', 'gap', 'qm_d_xy', 'dipm_d_x', 'qm_s_xx', 'delta_qm_e_zz',
    'delta_dipm_A', 'qm_d_yz','qm_A', 'qm_d_yy', 'dipm_p_y', 'p_s', 'dipm_p_z', 'delta_qm_Z', 'qm_p_xx', 

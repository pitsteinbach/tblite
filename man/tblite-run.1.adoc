...
*--mixer* _string_::
     Set the type of convergence accelerator (mixer) possible options:
     broyden (default), gambits-broyden, gambits-diis.

*--mixer-memory _int_:: 
     Number of past iterations to be used by the mixer.

*--mixer-precision _string_::
     Precision to be used by the mixer: single (default) or double

*--mixer-runmode _string_::
     Mixer runmode: default (size-dependent), cpu or gpu

*--mixer-damping _real_::
     Damping factor for mixing (default: 0.4)

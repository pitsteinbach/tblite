...
subroutine get_xtbml(self, mol, wfn, integrals, erep, calc, ccache, dcache, prlevel, a_array, res)
   ...
   self%delta_labels = [character(len=30) :: "delta_CN", "delta_q_A",&! 1 2
      &"delta_dipm_A",&! 3
...
subroutine pack_res(self, nat, nsh_tot, at2nsh, e_tot, labels, res)
   use tblite_xtbml_functions, only : pack_mult_xyz, pack_mult_xyz_shell, pack_shellwise
